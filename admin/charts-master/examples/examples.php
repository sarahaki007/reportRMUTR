...
<body>
	<div id="content">
		...
		*/
		...
		$barChart->set('data', array(array(20, 10, 16, 30, 42), array(42, 30, 16, 10, 2),array(42, 30, 16, 10, 2)));
		$barChart->set('legend', array('aaa', 'bbb', 'ccc', 'ddd', 'eeee'));
		// We don't to use the x-axis for the legend so we specify the name of each dataset
		$barChart->set('legendData', array('Annie', 'Marc','aaa'));
